...
class TestPessoa(unittest.TestCase):
    def setUp(self):
        ...
        self.p2 = Pessoa('Mari', 'Ferrer')

    def test_pessoa_attr_nome_tem_o_valor_correto(self):
        self.assertEqual(self.p1.nome, 'Luiz')
        self.assertEqual(self.p2.nome, 'Mari')

    def test_pessoa_attr_nome_tem_que_ser_str(self):
    ...
    def test_pessoa_attr_sobrenome_tem_o_valor_correto(self):
        ...
        self.assertEqual(self.p2.sobrenome, 'Ferrer')

    def test_pessoa_attr_sobrenome_tem_que_ser_str(self):
        self.assertIsInstance(self.p1.sobrenome, str)
        self.assertIsInstance(self.p2.sobrenome, str)

    def test_pessoa_attr_dados_obtidos_inicia_como_false(self):
    ...
    def test_obter_todos_os_dados_falha_404(self):
        with patch('requests.get') as fake_req:
            ...
            self.assertEqual(self.p1.obter_todos_os_dados(), 'Erro inesperado')
            self.assertFalse(self.p1.dados_obtidos)

            self.assertEqual(self.p2.obter_todos_os_dados(), 'Erro inesperado')
            self.assertFalse(self.p2.dados_obtidos)
